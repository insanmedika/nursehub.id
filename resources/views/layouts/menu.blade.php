<section class="relative mx-auto py-2 px-4  shadow-2 sticky bottom-1 z-50">
  <div class="px-7 bg-white shadow-lg rounded-2xl sm:hidden">
      <div class="flex">
          ...
          <div class="flex-1 group">
              <a href="/search" class="flex items-end justify-center text-center mx-auto px-4 pt-2 w-full text-gray-400 group-hover:text-primary border-b-2 border-transparent group-hover:border-primary">
                  <span class="block px-1 pt-1 pb-2">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
