...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    @if(count($blog)>0)
      ...
      <main class="mt-10">
        <div class="block md:flex md:space-x-2 px-2 lg:p-0">
          ...
          >
            ...
            <img src="/uploads/artikel/{{$blog[0]->image}}" class="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" />
            <div class="p-4 absolute bottom-0 left-0 z-20">
              <span class="px-4 py-1 bg-gray-700 text-gray-200 inline-flex items-center justify-center mb-2">{{$blog[0]->category}}</span>
              ...
              <div class="flex mt-3">
                ...
                <div>
                  <p class="font-semibold text-gray-200 text-sm">{{$blog[0]->author}}  </p>
                  <p class="font-semibold text-gray-400 text-xs">  <?php echo date("d F Y", strtotime($blog[0]->created_at));?> </p>
                </div>
              </div>
            </div>
          </a>
  
          <a class="hidden w-full md:w-1/3 relative rounded" 
            style="height: 24em;"
            href="#"
          >
        ...
        <div class="block lg:flex lg:space-x-2 px-2 lg:p-0 mt-10 mb-10">
          ...
          <div class="w-full">
            ...
            <a class="block rounded w-full lg:flex mb-10"
              href="/blog/{{$data->slug_judul}}"
            >
              <div 
                class="h-48 w-96 flex-none bg-cover text-center overflow-hidden opacity-75"
                style="background-image: url('/uploads/artikel/{{$data->image}}')" 
              ...
              <div class="bg-white rounded px-4 flex flex-col justify-between leading-normal">
                ...
                <div class="flex mt-3">
                  ...
                  <div>
                    <p class="font-semibold text-gray-700 text-sm capitalize"> {{$data->author}} </p>
                    <p class="text-gray-600 text-xs"> <?php echo date("d F Y", strtotime($blog[0]->created_at));?> </p>
                  </div>
                </div>
              </div>
            </a>
      ...
      @else
        <h1 class="font-bold text-center text-2xl">Artikel Masih Kosong</h1>
      @endif
      <!-- main ends here -->
