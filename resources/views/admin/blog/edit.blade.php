              ...
              <div class="px-4 py-5 bg-white sm:p-6 mx-auto">
                ...
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="judul" id="judul" autocomplete="given-name" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-lg border-gray-300 rounded-md" placeholder="Masukan Judul Artikel" required value="{{$blog->judul}}">
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="meta_desc" class="block text-lg font-bold text-gray-700">Meta Desc</label>
                    <input type="text" name="meta_desc" id="deadline" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-lg border-gray-300 rounded-md" placeholder="Masukan Deskripsi Artikel" required  value="{{$blog->meta_desc}}">
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <select id="post_type" name="post_type" autocomplete="post_type" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-lg">
                      <option  value="{{$blog->judul}}">{{$blog->judul}}</option>
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="category" id="deadline" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-lg border-gray-300 rounded-md" placeholder="Masukan Category Artikel" required  value="{{$blog->category}}">
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="image" class="block text-lg font-bold text-gray-700">Image</label>
                    <input  type="file" name="image" class="form-control">
                    <img src="/uploads/artikel/{{$blog->image}}" alt="" srcset="">
                    <input type="hidden" name="old_feature_image" value="{{$blog->image}}">
                  </div>
